    ...
    >
      <nav className="max-w-7xl mx-auto px-5 sm:px-8 flex items-center justify-between">
        <a
          ...
          className="font-display text-xl sm:text-2xl font-semibold text-ink tracking-tight"
        >
          NG<span className="text-gold">.</span>
        </a>
        ...
        <a
          ...
          download
          className="hidden lg:inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-ink text-white text-sm font-medium hover:bg-gold hover:text-ink transition-all duration-300 shadow-sm"
        >
          Resume
        </a>
            ...
            <ul className="flex flex-col px-5 py-4 gap-1">
              ...
              <li className="pt-2">
                <a
                  href={profile.resumeUrl}
                  download
                  className="block text-center px-4 py-3 rounded-xl bg-ink text-white font-medium"
                >
                  Download Resume
                </a>
              </li>
