          ...
          <Reveal className="lg:col-span-5" delay={0.1}>
            <div className="relative rounded-3xl bg-white border border-ink/8 shadow-[0_8px_40px_rgba(15,23,42,0.06)] p-8 sm:p-10">
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="pt-4 border-t border-ink/8 flex items-center gap-3">
                  <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-gold to-gold-light flex items-center justify-center font-display font-bold text-xl text-ink shadow-sm">
                    {about.cgpa}
                  </div>
                  <div>
                    <p className="font-semibold text-ink leading-none">CGPA</p>
                    <p className="text-sm text-slate">out of 10.0</p>
                  </div>
                </div>
              </div>
            </div>
