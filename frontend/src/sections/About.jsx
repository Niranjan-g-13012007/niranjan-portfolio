        ...
        <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 mt-10">
          ...
          <Reveal className="lg:col-span-5" delay={0.1}>
            <div className="relative rounded-3xl bg-white border border-ink/8 shadow-[0_8px_40px_rgba(15,23,42,0.06)] p-8 sm:p-10">
              <div className="absolute top-0 right-0 w-24 h-24 bg-gold/10 rounded-bl-[3rem] rounded-tr-3xl" />
              ...
              <div className="relative z-10 space-y-6">
                ...
                <div className="flex items-start gap-3">
                  <HiSparkles className="text-purple text-xl mt-0.5 shrink-0" />
                  <div>
                    <p className="font-mono text-xs text-gold uppercase tracking-widest mb-1">Specialization</p>
                    <p className="text-slate font-medium">MERN Stack Development, DBMS</p>
                  </div>
                </div>
