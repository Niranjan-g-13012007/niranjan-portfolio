    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none select-none hidden sm:block">
        {heroKeywords.map((kw, i) => (
          <motion.span
            key={kw}
            className="absolute font-mono text-sm md:text-base text-ink/[0.10] font-medium"
        ...
        >
          ...
          >
            <MagneticButton
              ...
              strength={0.25}
              className="group inline-flex items-center gap-2 px-6 py-3 rounded-full bg-ink text-white font-medium text-sm shadow-lg shadow-ink/10 hover:shadow-xl hover:bg-gold-dark transition-all duration-300"
            >
              View Projects
