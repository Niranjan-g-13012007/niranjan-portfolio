        ...
        >
          ...
          >
            ...
            <a
              ...
              download
              className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white border-2 border-gold text-ink font-medium text-sm hover:bg-gold/10 hover:-translate-y-0.5 transition-all duration-300 shadow-sm"
            >
              <FiDownload />
              Download Resume
            </a>
