    ...
    <Reveal delay={index * 0.06}>
      ...
      >
        ...
        <div className="relative flex items-start justify-between mb-4">
          <div className="w-11 h-11 rounded-xl bg-blue/10 flex items-center justify-center shrink-0">
    ...
    <Reveal delay={index * 0.08}>
      ...
      >
        ...
        <div className="relative flex items-center gap-3 mb-4">
          <div className={`w-12 h-12 rounded-2xl bg-gradient-to-br ${c.iconBg} flex items-center justify-center shadow-md shrink-0`}>
...
export default function Achievements() {
  return (
    <section id="achievements" className="relative py-24 sm:py-32 overflow-hidden">
      <div className="absolute inset-0 pointer-events-none hidden sm:block opacity-[0.05]">
